...
export default function ImpressionTongchengPage() {
  // 读取 impression-tongcheng.html 文件内容
  const htmlContent = readFileSync(
    join(process.cwd(), 'public', 'impression-tongcheng.html'),
    'utf-8'
  );
  ...
  bodyContent = bodyContent
    ...
    .replace(/href="tea-culture\.html"/g, 'href="/zh/tea-culture"')
