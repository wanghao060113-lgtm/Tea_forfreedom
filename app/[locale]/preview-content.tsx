      ...
      setTimeout(() => {
        if (typeof window !== 'undefined' && containerRef.current) {
          ...
          viewButtons.forEach((btn) => {
            ...
            (newBtn as HTMLElement).addEventListener('click', function(e: Event) {
              e.preventDefault();
              const productId = (this as HTMLElement).getAttribute('data-product');
          ...
          if (modal) {
            modal.addEventListener('click', function(e: Event) {
              if (e.target === this && (window as any).closeProductModal) {
